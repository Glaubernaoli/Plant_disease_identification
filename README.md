...
<h1 align="center"> Identificação de doenças fúngicas em plantas usando CNN e processamento de imagens
 
### Processamento de Imagens, Turma 2024
...
<div align="justify">
O objetivo deste trabalho é empregar imagens de folhas com ferrugem,
...
<div align="justify">
 ...
 `Redes Neurais Convolucionais  (CNNs)`: Esse método
possibilita a classificação de imagens, a partir de 3 tipos de
camadas: Camada Convolucional, onde ocorre a detecção de
funcionalidaes a partir de um Kernel; Camada de Agrupamento,
reduzindo a dimensionalidade e o números de parâmetros de
entrada e a Camada Totalmente Conectada, no qual acontece a
...
`Acurácia`: representa a proporção de todas as classificações corretas pelo
...
`Python`, `Jupyter Notebook`, `VS Code`, `Redes Neurais Convolucionais`, `Scikit Learn`, `Numpy`, `Pandas`, `Processamento de imagens`
...
1. IBM Brasil. O que são redes neurais convolucionais? https://www.ibm.
com/br-pt/think/topics/convolutional-neural-networks, 2025. Acesso
em: 10 nov. 2025.
2. James Morais de Almeida. Material de aula, disciplina: Processamento
de imagens, 2025. Material de Aula.
3. Vadim Irtlach. Plant disease classification [notebook]. https://www.
kaggle.com/code/vad13irt/plant-disease-classification/notebook, 2025.
